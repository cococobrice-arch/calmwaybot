...
async def finish_test(chat_id: int):
    ...
    if yes_count >= 4:
        text = (
            ...
            "➡️ Тем больше концентрируемся на своём теле ➡️ Тем больше чувствуем в нём разные неожиданные/неприятные ощущения ➡️ Тем больше переживаем по поводу них.\n\n"
            ...
            "Но не всё сразу! Возьмите для изменения сначала только одно правило и поработайте над отказом от него.\n\n"
