...
async def send_final_message(chat_id: int):
    ...
    text = (
        ...
        "Моя задача - привести Вашу жизнь в норму во всех аспектах. "
        ...
        "ниже можно узнать подробнее 👇🏽"
    )

    keyboard = InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text="Узнать про консультации", url="https://лечение-паники.рф/помощь-психотерапевта")]
        ]
    )
