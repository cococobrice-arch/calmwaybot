...
async def send_case_story(chat_id: int):
    ...
    "Наши с ней занятия состояли из двух блоков.\n\n"
    "<b>Экспозиция.</b>\n\n"
    ...
    "Для начала чтобы просто постоять там и позволить тревоге накатывать на неё волнами. "
    ...
    "что в тоннеле должно случиться что-то ужасное. Но мы заранее составляли план того, к появлению каких мыслей нужно быть готовой, "
    ...
    "постоянно соответствовать ожиданиям других людей, быть безошибочной, никого не разочаровывать. "
    ...
    "Спустя месяцы, когда она начала делегировать задачи другим людям, заявлять о своих потребностях, "
    "выполнять дела не на «5», а на «4» и не проверять каждое своё слово — внутреннее напряжение стало спадать. "
